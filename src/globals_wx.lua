...
add   ("wxNO_GRID_CELL_COORDS",                wx, "wxGridNoCellCoords")     -- wxGridCellCoords
...
-- wxFile
wxFILE_MODE_APPEND    = wxFile.write_append
wxFILE_MODE_READ      = wxFile.read
wxFILE_MODE_READWRITE = wxFile.read_write
wxFILE_MODE_WRITE     = wxFile.write
